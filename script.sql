...
(2, 'Thiết kế Bản nháp', 'Hóa Học', NULL, '2026-12-05', 1, 'Đang làm'),
(1, 'Đọc "Sapiens"', 'Lịch sử', NULL, '2026-05-15', 3, 'Đang làm'),
(3, 'Ôn tập Đại số', 'Toán', NULL, '2026-12-10', 2, 'Đang làm'),
(2, 'Viết báo cáo thí nghiệm', 'Hóa Học', NULL, '2026-08-01', 1, 'Đang làm'),
(1, 'Chuẩn bị bài thuyết trình', 'Văn', NULL, '2026-09-15', 2, 'Đang làm'),
(3, 'Làm bài tập về nhà', 'Vật Lý', NULL, '2025-03-20', 3, 'Quá hạn'),
(2, 'Đọc chương 3 Sách Sinh', 'Sinh học', NULL, '2026-10-05', 2, 'Đang làm'),
(1, 'Tìm hiểu về AI', 'Tin học', NULL, '2025-11-11', 1, 'Hoàn thành'),
(3, 'Luyện nghe tiếng Anh', 'Tiếng Anh', NULL, '2026-12-01', 3, 'Đang làm');
